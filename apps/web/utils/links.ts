...
export const githubrepoIssues = 'https://github.com/waldo-vision/waldo/issues';
export const mailto = 'mailto:support@waldo.vision';
export const twitter = 'https://twitter.com/waldovision';
